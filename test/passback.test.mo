...
actor class({ledgerId: Principal}) = this {
    ...
    ledger.onReceive(func (t) {
        switch(t.from) {
            case (#icp(_from)) {
                ignore ledger.send({ to = {owner = Principal.fromText("ydl4r-asr5o-7axs3-tshas-4xugy-bvg4x-ixnjd-6qex3-guw6d-5pahc-oqe"); subaccount = null}; amount = t.amount; from_subaccount = t.to.subaccount; });
            };
            case (_) ();
        };
